...
// func (w *testWorker) init(uint32)             {}
// func (w *testWorker) cachedEventSize() uint64 { return 0 }
// func (w *testWorker) handleEvent(cb func(p uint32, offset uint64)) (bool, bool) {
// 	time.Sleep(time.Millisecond * 10)
// 	return true, true
// }

// func (w *testWorker) initCompleted() bool {
// 	return true
// }

// func (w *testWorker) resetOffsets([]uint64) {
